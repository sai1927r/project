...
**Interaction Test:** The significance of the interaction effect was evaluated using an ANOVA test with type III sums of squares via the Anova function from the car package.
